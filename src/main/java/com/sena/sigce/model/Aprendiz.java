...
public class Aprendiz {
    ...
    public Aprendiz(String identificacion_Apr, String tipoIde_Apr, String nombre_Apr, String apellido_Apr,
            String correo_Apr, String password_Apr, Ficha ficha, Estado estado) {
