...
public class Funcionario {
    ...
    public Funcionario(String identificacion_Fun, String tipoIde_Fun, String nombre_Fun, String apellido_Fun,
            String correo_Fun, String password_Fun, Estado estado) {
